...
<div class="btn-group-toggle" data-toggle="buttons">
        <a href="login.php" type="button" class="btn btn-primary btn-sm active" role="button" aria-pressed="true">Sair!</a>
        </label>
    </div>
    <div class="wrapper col-12">
        <h2><img class="img1" src="img/icone.png">Redefinir senha</h2>
